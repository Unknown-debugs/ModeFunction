 ...
 * Modified by: Junhwan Lee
 * Purpose: Improve the program of calculating modes by implement set
 * Date: 5/16/2021 11:06 PM
 */
...
int *mode(const int *array, int arySize) {
    ...
    // Get number of modes by subtracting size
    int nModes = arySize - myset.size();
    ...
    // Transfer elements from set to the mode array
    int i = 2;
